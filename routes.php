...
$app->group('/api', function () use ($app) {
    ...
    $app->delete('/condo/[{id}]', function ($request, $response, $args) {
     ...
     // Update condo with given id // put method is does not work!!!! use post instead
     $app->post('/condo/[{id}]', function ($request, $response, $args) {
        ...
        if($newfileName != ""){
            $sql = "UPDATE condo SET condo_name=:condo_name, condo_price=:condo_price, condo_detail=:condo_detail, condo_img=:condo_img, WHERE id=:id";
        }else{
            $sql = "UPDATE condo SET condo_name=:condo_name, condo_price=:condo_price, condo_detail=:condo_detail,  WHERE id=:id";
        }
